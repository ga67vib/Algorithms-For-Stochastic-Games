  ...
  public static final	String PRISM_INTERVAL_ITER_OPTIONS			= "prism.intervalIterOptions";
	...
	public static final Object[][][] propertyData =
	{
		{	//Datatype:			Key:									Display name:							Version:		Default:																	Constraints:																				Comment:
			...
			{ CHOICE_TYPE,		PRISM_SMG_SOLN_METHOD,					"SMG solution method",				"Maxi0",			"Value iteration",																"Value iteration,Interval iteration,Sound value iteration,Optimistic value iteration,Quadratic programming,Policy iteration,Gauss-Seidel,Analyse,Optimistic interval iteration",
	...
	public synchronized int setFromCommandLineSwitch(String args[], int i) throws PrismException
	{
		...
		// Linear equation solver + MDP soln method
			...
			set(PRISM_SMG_SOLN_METHOD, "Gauss-Seidel");
			...
			set(PRISM_SMG_SOLN_METHOD, "Value iteration");
		} else if (sw.equals("politer")) {
			set(PRISM_MDP_SOLN_METHOD, "Policy iteration");
			set(PRISM_SMG_SOLN_METHOD, "Policy iteration");
		...
		else if (sw.equals("oii")) {
			set(PRISM_SMG_SOLN_METHOD, "Optimistic interval iteration");
		}
		...
		// Interval iterations
			...
			set(PRISM_SMG_SOLN_METHOD, "Interval iteration");
