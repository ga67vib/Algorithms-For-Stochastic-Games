...
output_dir="manyMEC"
random_input_dir = "../random-generated-models/manyAct_small/"
...
configurations["TBVI_100_DTMC"] = (prism_path, "-ii -maxiters 100 -topological")
configurations["TBVI_100_LP"] = (prism_path, "-ii -maxiters 100 -topological")
...
configurations["TGBVI_100_DTMC"] = (prism_path, "-ii -maxiters 100 -topological -smg_opts 1")
configurations["TGBVI_100_LP"] = (prism_path, "-ii -maxiters 100 -topological -smg_opts 1")
...
configurations["TOVI_100_DTMC"] = (prism_path, "-ovi -maxiters 100 -topological")
configurations["TOVI_100_LP"] = (prism_path, "-ovi -maxiters 100 -topological")
...
configurations["TOVI_100_opt_DTMC"] = (prism_path, "-ovi -maxiters 100 -topological -smg_opts 4")
configurations["TOVI_100_opt_LP"] = (prism_path, "-ovi -maxiters 100 -topological -smg_opts 4")

# QP
configurations["QP_G"] = (prism_path, "-qp -smg_opts 0")    	#QP improved approach
#configurations["QP_G_W"] = (prism_path, "-qp -smg_opts 1")    	#Give Gurobi additional start-vector from VI
#configurations["QP_C"] = (prism_path, "-qp -smg_opts 3")     	#C = Cplex Model Created (by Gurobi)
#configurations["QP_CON"] = (prism_path, "-qp -smg_opts 4")     	#Condon's original QP
# configurations["QP_ECM"] = (prism_path, "-qp -smg_opts 5")     	#Solve ECs with Condon's m-chain
#configurations["QP_ECE"] = (prism_path, "-qp -smg_opts 6")     	#Solve ECs with Epsilon-transitions
configurations["QP_G_T"] = (prism_path, "-qp -smg_opts 7")     	#Gurobi, Topological
#configurations["QP_G_T_W"] = (prism_path, "-qp -smg_opts 8")    	#Gurobi, Topological, Warm Start with VI
configurations["AMPL_M"] = (prism_path, "-qp -smg_opts 9")  	#AMPL Minos
#configurations["AMPL_W"] = (prism_path, "-qp -smg_opts 8")     	#AMPL Minos, Warm start (not implemented)
configurations["AMPL_T"] = (prism_path, "-qp -smg_opts 11")     	#AMPL With topological sort
...
models["ManyMECs_10"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=10"
models["ManyMECs_50"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=50"
models["ManyMECs_100"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=100"
models["ManyMECs_200"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=200"
models["ManyMECs_300"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=300"
models["ManyMECs_400"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=400"
models["ManyMECs_500"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=500"
models["ManyMECs_600"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=600"
models["ManyMECs_700"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=700"
models["ManyMECs_800"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=800"
models["ManyMECs_900"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=900"
models["ManyMECs_1000"]="../case-studies/ManyMecs.prism ../case-studies/ManyMecs.props -const N=1000"
    ...
    for conf_count, conf in enumerate(sorted(configurations.keys())):
        ...
        for model_count, model in enumerate(sorted(models.keys())):
            ...
            for i in range(1, reps+1):
                ...
                command = "timeout 2m " + configurations[conf][0] + " " + \
