...
if __name__ != '__main__':
    ...
    from .file_loader_utils import is_float, transpose_array_of_dicts
...
def load_file(property_keys : List[str], paths_to_csv_files : Union[List[str], str], primary_key_name : str = "Model", filter_function : Callable[..., bool] = None, penalty_for_not_providing_value = -1) -> FileData:
    file_data = None
...
def _load_one_file(property_keys : List[str], path_to_csv_file : str, primary_key_name : str = "Model", filter_function : Callable[..., bool] = None, penalty_for_not_providing_value = -1) -> FileData:
    table = []
        ...
        for row in reader:
            ...
            for key in property_keys:
                ...
                if (not is_float(relevant_key_value_pairs[key]) and key != primary_key_name):
                    relevant_key_value_pairs[key] = penalty_for_not_providing_value
